          ...
          <Card.Description>
            <Container textAlign="center">
              ...
              <h6 style={{paddingLeft: '30px', paddingRight: '30px'}}>
                {transaction.diognosisDescription}
              </h6>
            </Container>
            {/* <hr/>
    ...
    return (
      <AuthBoilerplate history={this.props.history}>
        <Container padded="true" style={{ padding: "20px" }}>
          <Segment>
            <h3 style={{display: 'inline'}}>List of Diagnosis</h3> 
            <div style={{position: 'absolute', right: '20px', display: 'inline'}}>
              ...
              <Button 
                ...
                labelPosition="left"
                color="green" 
                onClick={() => {this.props.history.push(`addDiagnosis`)}}
              >
                <Icon name="plus"/>
                Add new diagnosis
              </Button>
          ...
          </Segment>
            {
              ...
              <Segment><Message warning>There are no diagnosis for this patient at the moment</Message></Segment> :
              <div />
            }
          <br/>
          <Card.Group>
